...
{
		cout << "======================================================" << endl;
					cout << left << "Bus ID" << "\t" << "Bus Manufacturer"
						 << " " << "Bus Capacity" << "  " << "Mileage"
						 << "\t" << "Status" << endl;
					cout << "======================================================" << endl;
}
...
void BusManager::cleanup()
{
	...
	{
		delete ptrArray[i];
		cout << "Success fully deleted Bus " << i+1 << endl;
	}
	cout << "Completely deleted all buses!" << endl;
};
